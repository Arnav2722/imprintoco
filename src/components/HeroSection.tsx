...
//               OWN YOUR <br />
//               {/* <span className="text-[#5ce1e6] italic">OBSESSION.</span> */}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 sm:px-12 py-4">
        <div className="max-w-full lg:max-w-5xl">
          ...
          <div className="mb-8 md:mb-12">
            <h1 className="font-display text-[10vw] sm:text-6xl md:text-7xl lg:text-7xl font-black leading-[1.1] tracking-tighter uppercase break-words">
              OWN YOUR <br />
