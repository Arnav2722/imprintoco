...
type DeliveryStatus = "idle" | "checking" | "valid" | "invalid";
    ...
    return (
      ...
      >
        <button
          ...
          className="w-full flex justify-between items-center p-6 text-[11px] font-black tracking-widest uppercase"
        >
          <div className="flex items-center gap-4">
            <span className={isOpen ? "text-primary" : "text-foreground/20"}>
              {icon}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="overflow-hidden"
            >
              <div className="px-16 pb-8 text-[12px] font-bold uppercase space-y-4 text-foreground/60">
                {content}
              </div>
            </motion.div>
          )}
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-12">
              <div>
                ...
                <div
                  className={`grid gap-3 ${isKit ? "grid-cols-3" : "grid-cols-2 sm:grid-cols-4"}`}
                >
              ...
              {/* Action UI and Footer same as your original, now safe from "any" errors */}
              {/* ... */}
            </div>
          </div>
        </div>
